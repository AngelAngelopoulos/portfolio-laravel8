        ...
        <div class="container pt-2 pt-lg-0">
            <div class="portfolio-details-container">
                ...
                <div class="owl-carousel portfolio-details-carousel" data-aos="fade-left">
                    @if($project->image)
                        <img class="card-img-top image-fluid" style="width: 100%"
                             src="{{ config('app.b2_general_url').$project->image  }}" alt="{{ $project->image }}">
                    @endif
                </div>
            ...
            <div class="portfolio-description" data-aos="fade-up">
                ...
                <div class="d-flex justify-content-between mt-5">
                    <div class=" float-left">
                        <a class="btn btn-dark rounded-pill" href="{{ route('projects.index') }}">Return to
                            portfolio</a>
                    </div>
