...
<header id="header">
    <div class="d-flex flex-column">
        ...
        <div class="profile py-2">
            ...
            <h1 class="text-light mx-auto pt-2"><a href="index.html">Angel Alvarado</a></h1>
            <div class="social-links mt-3 text-center pb-2">
        ...
        <nav class="nav-menu nav navbar-nav">
            <ul class="py-2">
                @auth
                    <li>
                        <span
                            class="text-white-50 px-3 title m-0"> Welcome back <b>{{ auth()->user()->name }}!!</b></span>
                    </li>
                @endauth
